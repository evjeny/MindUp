...
public class TextCreator {
    ...
    private String spaceStory() {
        ...
        space_people_total = space_ships*random.nextInt(6)+1;
        ...
        main_story.replace("@year",String.valueOf(space_year));
        main_story.replace("@color_planet", space_color_planet);
        main_story.replace("@color_star", space_color_star);
        main_story.replace("@planet_name", space_name_planet);
        main_story.replace("@star_name", space_name_star);
        main_story.replace("@men_count", String.valueOf(space_men));
        main_story.replace("@women_count", String.valueOf(space_women));
        main_story.replace("@spaceship_count", String.valueOf(space_ships));
        main_story.replace("@engineer_class", String.valueOf(eng_class));
        main_story.replace("@engineer_name", space_eng);
        main_story.replace("@doctor_class", String.valueOf(doc_class));
        main_story.replace("@doctor_name", space_doc);
        main_story.replace("@chemist_class", String.valueOf(chem_class));
        main_story.replace("@chemist_name", space_chem);
        main_story.replace("@days_count", String.valueOf(space_days));
        main_story.replace("@cap_name", space_name_cap);
        main_story.replace("@saver_name", space_name_saver);
        return main_story;
    }
    ...
    public int getSpace_people_total() {
        return space_people_total;
    }
